...
public sealed class AppFileSyncApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly SqliteConnection connection = new("Data Source=:memory:");

    public AppFileSyncDbContext CreateDbContext()
    {
        var scope = Services.CreateScope();
        return scope.ServiceProvider.GetRequiredService<AppFileSyncDbContext>();
    }
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            services.RemoveAll<DbContextOptions<AppFileSyncDbContext>>();
            services.RemoveAll<DbContextOptions>();
            services.RemoveAll<AppFileSyncDbContext>();
            services.AddDbContext<AppFileSyncDbContext>(options => options.UseSqlite(connection));
