...
public sealed class AppFileSyncClient(
    HttpClient httpClient,
    AppFileSyncClientOptions options,
    IAppFileSyncTokenProvider tokenProvider,
    IFileEncryptor encryptor,
    IAppFileSyncStateStore? stateStore = null)
    : IAppFileSyncClient
{
    private static readonly JsonSerializerOptions JsonOptions = new(JsonSerializerDefaults.Web);
    private readonly IAppFileSyncStateStore syncStateStore = stateStore ?? new InMemoryAppFileSyncStateStore();
